...
public class Solution {
    ...
    static {//добавляем в массив значения
    ...
    public static void main(String[] args) throws InterruptedException {
        StringBuffer expectedResult = new StringBuffer();//формируем первую строку значениями из массива
        ...
        StringBuffer result = new StringBuffer(); //создаем новую строку которая еще раз заполняется новыми значениями из массива
    ...
    public static void initThreads() throws InterruptedException {//заполняем лист потоками//запускаем первый поток//второй ждет пока закончится первый
